(function(b) {
    function a(a, c, b) {
        for (var d = a.length, i = c.length, j, k, p, q, o, l = {
            x: 0,
            y: 0
        }, m = 0; m < d; m++) {
            j = a[m];
            ...
            for (var n = 1; n < d; n++) o = a[n].x * l.x + a[n].y * l.y, o > k ? k = o : o < j && (j = o);
            p = q = c[0].x * l.x + c[0].y * l.y;
            for (n = 1; n < i; n++) o = c[n].x * l.x + c[n].y * l.y, o > q ? q = o : o < p && (p = o);
            j < p ? (j = p - k, l.x = -l.x, l.y = -l.y) : j -= q;
            if (j >= 0) return !1;
            else if (j > b.overlap) b.overlap = j, b.normal.x = l.x, b.normal.y = l.y
        }
        return b
    }
    var c = b.Quark = b.Quark || {
            version: "1.0.0",
            global: b
        },
        d = function() {};
    ...
    c.createDOM = function(a, c) {
        ...
        for (d in c) {
            var i = c[d];
            if (d == "style")
                for (var j in i) b.style[j] = i[j];
            else b[d] = i
        }
        return b
    };
    c.use = function(a) {
        for (var a = a.split("."), c = b, d = 0; d < a.length; d++) var g = a[d],
            c = c[g] || (c[g] = {});
        return c
    };
    (function(a) {
    ...
    c.getElementOffset = function(a) {
        for (var c =
                a.offsetLeft, b = a.offsetTop;
            (a = a.offsetParent) && a != document.body && a != document;) c += a.offsetLeft, b += a.offsetTop;
        return {
            left: c,
            top: b
        }
    ...
    c.createDOMDrawable = function(a, b) {
        ...
        k.style.width = i + "px";
        k.style.height = j + "px";
        if (d == "canvas") k.width = i, k.height = j, g && (d = k.getContext("2d"), i = b.rect || [0, 0, i, j], d.drawImage(g,
            i[0], i[1], i[2], i[3], a.x || 0, a.y || 0, a.width || i[2], a.height || i[3]));
        else if (k.style.opacity = a.alpha != void 0 ? a.alpha : 1, k.style.overflow = "hidden", g && g.src) k.style.backgroundImage = "url(" + g.src + ")", k.style.backgroundPosition = -(a.rectX || 0) + "px " + -(a.rectY || 0) + "px";
        return k
    };
    ...
    c.hitTestPoint = function(a, c, b, d) {
        ...
        if (j && d) {
            for (var d = 0, j = !1, k, p, q, o, l = 0; l < i; l++) {
                var m = a[l],
                    n = a[(l + 1) % i];
                if (m.y == n.y && b == m.y && (m.x > n.x ? (k = n.x, p = m.x) : (k = m.x, p = n.x), c >= k && c <= p)) {
                    j = !0;
                    continue
                }
                m.y > n.y ? (q = n.y, o = m.y) : (q = m.y, o = n.y);
                b < q || b > o || (m = (b - m.y) * (n.x - m.x) / (n.y - m.y) + m.x, m > c ? d++ : m == c && (j = !0))
            }
            if (j) return 0;
    ...
    c.hitTestObject = function(a, b, d) {
        a = a.getBounds();
        b = b.getBounds();
        return (a = a.x <= b.x + b.width && b.x <= a.x + a.width && a.y <= b.y + b.height && b.y <= a.y + a.height) && d ? (a = c.polygonCollision(b, b), a !== !1) : a
    };
...
(function() {
    ...
    b.prototype.containsPoint = function(a, c) {
        return this.x <= a && a <= this.x + this.width && this.y <= c && c <= this.y + this.height
    };
    b.prototype.clone = function() {
...
(function() {
    ...
    b.prototype.registerStage = function(a, c, b, e) {
        this.register(a.context.canvas, c, {
            host: a,
            func: a._onEvent
        }, b, e)
    };
    ...
    b.prototype.register = function(a, c, b, e, f) {
        ...
        for (var h = {
            ...
            for (var i = c[f], j = this._evtHandlers[i] ||
                (this._evtHandlers[i] = []), k = 0, p = !1; k < j.length; k++) {
                var q = j[k];
    ...
    b.prototype._onEvent = function(a, c, d) {
        var e = a,
            f = a.type;
        if (a.type.indexOf("touch") == 0) e = a.touches && a.touches.length > 0 ? a.touches[0] : a.changedTouches && a.changedTouches.length > 0 ? a.changedTouches[0] : a, e.type = f;
        if (f == "keydown" || f == "keyup" || f == "keypress") this.keyState[a.keyCode] = f;
        d.func != null && d.func.call(d.host, e);
        b.stop(a, !c.prevent, !c.stop)
    };
    b.stop = function(a, c, b) {
        c || a.preventDefault();
        b || (a.stopPropagation(), a.stopImmediatePropagation && a.stopImmediatePropagation())
    }
})();
(function() {
    ...
    b.prototype.removeEventListener = function(a, c) {
        ...
        for (var e = 0; e < b.length; e++)
            if (b[e] === c) return b.splice(e, 1), b.length == 0 && delete this._eventMap[a], !0;
        return !1
    };
...
(function() {
    function b(a, c) {
        for (var d = 0; d < a.children.length; d++) {
            ...
            if (g.children) b(g, c);
                ...
                c.stroke();
                c.closePath()
            } else if (g.drawable.domDrawable) g.drawable.domDrawable.style.border =
                "1px solid #f00"
        }
    }
    Quark.getUrlParams = function() {
        ...
        var a = {},
            ...
            b = c.indexOf("?");
        if (b > 0)
            for (var c = c.substring(b + 1).split("&"), b = 0, d; d = c[b]; b++) e = c[b] = d.split("="), d = e, a[d[0]] = d.length > 1 ? d[1] : !0;
        return a
    };
    var a = document.head,
    ...
    Quark.toggleDebugRect = function(a) {
        a.debug = !a.debug;
        a._render = a.debug ? function(c) {
            c.clear != null && c.clear(0, 0, a.width, a.height);
            Quark.Stage.superClass._render.call(a, c);
            c = a.context.context;
            if (c != null) c.save(), c.lineWidth = 1, c.strokeStyle = "#f00", c.globalAlpha = 0.5;
            b(a, c);
            c != null && c.restore()
        } : function(c) {
            c.clear != null && c.clear(0, 0, a.width, a.height);
...
(function() {
    ...
    b.prototype._run = function() {
        if (!this.paused) {
            ...
            for (var b = 0, e = this._listeners.length, f, h; b < e; b++) f = this._listeners[b], h = f.__runTime || 0, h == 0 ? f.step(this.info) : c > h && (f.step(this.info), this._listeners.splice(b, 1), b--, e--);
            a.lastTime = c
        }
    };
    ...
    b.prototype.addListener =
        function(a) {
            if (a == null || typeof a.step != "function") throw "Timer Error: The listener object must implement a step() method!";
...
(function() {
    ...
    b.prototype._addSource = function(a) {
        if (a) {
            for (var a = a instanceof Array ? a : [a], c = 0; c < a.length; c++) this._totalSize += a[c].size || 0;
            this._source = this._source ?
                this._source.concat(a) : a
        }
    };
    b.prototype._loadNext = function() {
        this._index++;
        if (this._index >= this._source.length) this.dispatchEvent({
            type: "complete",
            target: this,
            images: this._images
        }), this._source = [], this.loading = !1, this._index = -1;
        else {
            var a = new Image;
...
(function() {
    var b = Quark.Tween = function(c, b, e) {
        ...
        for (var f in b) {
            var h = c[f],
                g = b[f];
            h !== void 0 && typeof h == "number" && typeof g == "number" && (this._oldProps[f] = h, this._newProps[f] = g, this._deltaProps[f] =
                g - h)
        }
    ...
    b.prototype.setProps = function(a, b) {
        ...
        for (e in b) this._newProps[e] = b[e], this._deltaProps[e] = b[e] - this.target[e]
    };
    ...
    b.prototype._update = function() {
        if (!this.paused) {
            ...
            if (!(d < 0)) {
                ...
                this._lastTime = a;
                a = this._frameTotal > 0 ? ++this._frameCount / this._frameTotal : d / this.time;
                a > 1 && (a = 1);
                var d = this.ease(a),
                    e;
                for (e in this._oldProps) this.target[e] = this._oldProps[e] + this._deltaProps[e] * this._reverseFlag * d;
                if (this.onUpdate != null) this.onUpdate(this, d);
                if (a >= 1) {
                    if (this.reverse) {
                        if (e = this._oldProps, this._oldProps = this._newProps, this._newProps =
                            e, this._startTime = Date.now(), this._frameCount = 0, this._reverseFlag *= -1, !this.loop) this.reverse = !1
                    } else if (this.loop) {
                        for (e in this._oldProps) this.target[e] = this._oldProps[e];
                        this._startTime = Date.now();
                        this._frameCount = 0
                    } else if (b.remove(this), e = this.next, e != null && (e instanceof b ? (a = e, e = null) : a = e.shift(), a != null)) a.next = e, a.start();
    ...
    b.add = function(a) {
        this._tweens.indexOf(a) ==
            -1 && this._tweens.push(a);
        return this
    };
    b.remove = function(a) {
        var b = this._tweens,
    ...
    a.Elastic.EaseIn = function(a) {
        ...
        !e ||
            e < 1 ? (e = 1, b = f / 4) : b = f / (2 * Math.PI) * Math.asin(1 / e);
        return -(e * Math.pow(2, 10 * (a -= 1)) * Math.sin((a - b) * 2 * Math.PI / f))
    };
    a.Elastic.EaseOut = function(a) {
        ...
        !e || e < 1 ? (e = 1, b = f / 4) : b = f / (2 * Math.PI) * Math.asin(1 / e);
    ...
    a.Elastic.EaseInOut = function(a) {
        ...
        !e || e < 1 ? (e = 1, b = f / 4) : b = f / (2 * Math.PI) * Math.asin(1 / e);
        return (a *= 2) < 1 ? -0.5 * e * Math.pow(2,
            10 * (a -= 1)) * Math.sin((a - b) * 2 * Math.PI / f) : e * Math.pow(2, -10 * (a -= 1)) * Math.sin((a - b) * 2 * Math.PI / f) * 0.5 + 1
    };
    ...
    a.Bounce.EaseOut = function(a) {
        return (a /= 1) < 1 / 2.75 ? 7.5625 * a * a : a < 2 / 2.75 ? 7.5625 * (a -= 1.5 / 2.75) * a + 0.75 : a < 2.5 /
            2.75 ? 7.5625 * (a -= 2.25 / 2.75) * a + 0.9375 : 7.5625 * (a -= 2.625 / 2.75) * a + 0.984375
    };
    a.Bounce.EaseInOut = function(b) {
        return b < 0.5 ? a.Bounce.EaseIn(b * 2) * 0.5 : a.Bounce.EaseOut(b * 2 - 1) * 0.5 + 0.5
    }
})();
(function() {
    ...
    b.prototype._evtHandler = function(a) {
        if (a.type == "progress") {
            ...
            if (d / a.target.duration >= 1) this._element.removeEventListener("progress", this._evtHandler), this._element.removeEventListener("error", this._evtHandler), this._loaded = !0, this.dispatchEvent({
                type: "loaded",
                target: this
            }), this.autoPlay && this.play()
        } else a.type ==
            "ended" ? (this.dispatchEvent({
                type: "ended",
                target: this
            }), this.loop ? this.play() : this._playing = !1) : a.type == "error" && trace("Quark.Audio Error: " + a.target.src)
    };
...
(function() {
    ...
    b.prototype.get = function(a, b) {
        if (b == null || b.canvas.getContext != null) return this.rawDrawable;
            ...
            if (this.domDrawable == null) this.domDrawable = Quark.createDOMDrawable(a, {
    ...
    b.prototype.set = function(a, b) {
        if (a instanceof HTMLImageElement || a instanceof HTMLCanvasElement || a instanceof HTMLVideoElement) this.rawDrawable = a;
        if (b === !0) this.domDrawable = a;
        else if (this.domDrawable) this.domDrawable.style.backgroundImage =
...
(function() {
    ...
    b.prototype.setDrawable = function(a) {
        this.drawable == null ? this.drawable = new Quark.Drawable(a) : this.drawable.rawDrawable != a && this.drawable.set(a)
    };
    ...
    b.prototype._render = function(a) {
        a = this.context || a;
        !this.visible || this.alpha <= 0 ? (a.hide != null && a.hide(this), this.saveState(["visible",
            "alpha"
        ])) : (a.startDraw(), a.transform(this), this.render(a), a.endDraw(), this.saveState())
    };
    ...
    b.prototype.saveState = function(a) {
        for (var a = a || this._stateList, b = this._lastState, d = 0, e = a.length; d < e; d++) {
            var f = a[d];
            b["last" + f] = this[f]
        }
    };
    ...
    b.prototype.propChanged =
        function() {
            for (var a = arguments.length > 0 ? arguments : this._stateList, b = 0, d = a.length; b < d; b++) {
                var e = a[b];
    ...
    b.prototype.getConcatenatedMatrix = function(a) {
        ...
        for (var d = this; d.parent != null && d.parent != a; d = d.parent) {
            var e = 1,
                f = 0;
            d.rotation % 360 != 0 && (f = d.rotation * Quark.DEG_TO_RAD, e = Math.cos(f), f = Math.sin(f));
            d.regX != 0 && (b.tx -= d.regX);
            d.regY != 0 && (b.ty -= d.regY);
            b.concat(new Quark.Matrix(e * d.scaleX, f * d.scaleX, -f * d.scaleY, e * d.scaleY, d.x,
                d.y))
        }
        return b
    };
...
(function() {
    ...
    b.prototype.addChild = function(a) {
        for (var b = this.children.length, d = 0; d < arguments.length; d++) a = arguments[d], this.addChildAt(a,
            b + d);
        return this
    };
    ...
    b.prototype.render = function(a) {
        ...
        for (var c = 0, d = this.children.length; c < d; c++) this.children[c]._render(a)
    };
    b.prototype.getObjectUnderPoint = function(a, b, d, e) {
        ...
        for (var h = this.children.length - 1; h >= 0; h--) {
            ...
            if (!(g ==
                null || !g.eventEnabled && g.children == void 0 || !g.visible || g.alpha <= 0))
...
(function() {
    ...
    b.prototype._update = function(a) {
        for (var b = this.children.slice(0), d = 0, e = b.length; d <
            e; d++) {
            var f = b[d];
            f._depth = d;
            f._update(a)
    ...
    b.prototype._onEvent = function(a) {
        ...
        a.eventX = b;
        a.eventY = d;
        if (e != null && e != f) a.lastEventTarget = e, (b = a.type == "mousemove" ? "mouseout" : a.type == "touchmove" ? "touchout" : null) && e._onEvent({
                type: b
            }), this._eventTarget =
            null;
        if (f != null && f.eventEnabled) a.eventTarget = e = this._eventTarget = f, f._onEvent(a);
        if (!Quark.supportTouch) this.context.canvas.style.cursor = e && e.useHandCursor && e.eventEnabled ? "pointer" : "";
        if (this.onEvent != null) this.onEvent(a)
    };
...
(function() {
    ...
    b.prototype.addFrame = function(a) {
        ...
        else this.setFrame(a,
            b);
        return this
    };
    b.prototype.setFrame = function(a, b) {
        b == void 0 || b > this._frames.length ? b = this._frames.length : b < 0 && (b = 0);
        this._frames[b] = a;
    ...
    b.prototype.getFrameIndex = function(a) {
        ...
        for (var a = this._frameLabels[a], b = this._frames, d = 0; d < b.length; d++)
            if (a == b[d]) return d;
        return -1
    };
    b.prototype.nextFrame = function(a) {
        var b = this._frames[this.currentFrame];
        if (b.interval > 0) a = this._displayedCount + a, this._displayedCount = b.interval > a ? a : 0;
        if (b.jump >= 0 || typeof b.jump == "string")
            if (this._displayedCount ==
                0 || !b.interval) return this.currentFrame = this.getFrameIndex(b.jump);
        return b.interval > 0 && this._displayedCount > 0 ? this.currentFrame : this.currentFrame >= this._frames.length - 1 ? this.currentFrame = 0 : ++this.currentFrame
    };
    b.prototype._update = function(a) {
        var c = this._frames[this.currentFrame];
        c.stop ? this.stop() : (this.paused || this.nextFrame(this.useFrames ? 1 : a && a.deltaTime), this.setRect(c.rect), b.superClass._update.call(this, a))
    };
    b.prototype.render = function(a) {
...
(function() {
    ...
    b.prototype.setEnabled = function(a) {
        ...
        (this.eventEnabled = this.enabled = a) ? this.currentFrame == 3 && this._skin.gotoAndStop(b.UP): this.disabledState ? this._skin.gotoAndStop(b.DISABLED) : this._skin.gotoAndStop(b.state.UP);
        return this
    };
    ...
    b.prototype.setDrawable = function() {
        b.superClass.setDrawable.call(this,
            null)
    }
})();
(function() {
...
(function() {
    ...
    b.prototype.transform = function(a) {
        ...
        a.rotation %
            360 != 0 && b.rotate(a.rotation % 360 * Quark.DEG_TO_RAD);
    ...
    h.prototype.transform = function(a) {
        ...
        if (a.transformEnabled || !a._addedToDOM) {
            var d = Quark.cssPrefix,
                e = d + "TransformOrigin";
            d += "Transform";
            if (!c.style.display || a.propChanged("visible", "alpha")) c.style.display = !a.visible || a.alpha <= 0 ? "none" : "";
            if (!c.style.opacity || a.propChanged("alpha")) c.style.opacity = a.alpha;
            if (!c.style.backgroundPosition ||
                a.propChanged("rectX", "rectY")) c.style.backgroundPosition = -a.rectX + "px " + -a.rectY + "px";
            if (!c.style.width || a.propChanged("width", "height")) c.style.width = a.width + "px", c.style.height = a.height + "px";
            if (!c.style[e] || a.propChanged("regX", "regY")) c.style[e] = a.regX + "px " + a.regY + "px";
            if (!c.style[d] || a.propChanged("x", "y", "regX", "regY", "scaleX", "scaleY", "rotation")) e = Quark.supportTransform3D ? b(a, !0) : b(a, !1), c.style[d] = e;
            if (!c.style.zIndex || a.propChanged("_depth")) c.style.zIndex = a._depth
        }
    };
    h.prototype.hide = function(a) {
        a.getDrawable(this).style.display =
            "none"
    };
